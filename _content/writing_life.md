...
**25 minutes — Teaching: One Practical Topic**
I will walk you through one specific piece of the publishing process — the cover letter, the query, the agent search, the contest economics — using real examples wherever possible: real cover letters, real queries, real rejection slips, including my own.

**20 minutes — Discussion**
We talk it through together. You ask questions. I answer honestly, including when the honest answer is "no one knows" or "it depends." The publishing world runs on rumor and anxiety, and an open, unembarrassed conversation dissolves a surprising amount of both.

**35 minutes — Practical Work**
You do the thing. You draft the cover letter. You research three journals. You set up the spreadsheet. You write the query. The point of this course is not that you understand publishing in the abstract but that you leave each week with a concrete piece of your own submission machinery built.

**10 minutes — Take-Home Action & Wrap**
Each session ends with a specific take-home action to complete before the next meeting. Yes, there is homework. It is not graded. It is the work itself.
...
### Session 1 — Welcome & The Honest Landscape
...
### Reading
- Jane Friedman, "Lessons From 23 Years as a Self-Publishing Novelist" — [janefriedman.com](https://janefriedman.com/lessons-from-23-years-as-a-self-publishing-novelist/) *(a working writer's honest account of one of the four paths)*
- Poets & Writers, "Literary Magazines" overview — [pw.org](https://www.pw.org/content/literary_magazines) *(where most working writers actually begin)*

### Critical Reception
- *Poets & Writers Magazine* (the free article archive) — [pw.org](https://www.pw.org) — the central free hub for the contemporary literary-publishing landscape: contests, MFA data, agents, and grants.
- *Choosing a Literary Agent (Authors Guild)* — [authorsguild.org](https://authorsguild.org/resource/choosing-a-literary-agent/) — a sober, free guide to where agented book publishing fits among the paths.
- *The Business of Being a Writer — Jane Friedman's blog* — [janefriedman.com/blog](https://www.janefriedman.com/blog/) — the most reliable free running commentary on how the industry really pays (and doesn't).
...
### Session 2 — Reading Like a Submitter: The Literary Magazine Ecosystem
...
### Reading
- *Brevity* (read three recent flash essays) — [brevitymag.com](https://brevitymag.com)
- *SmokeLong Quarterly* (read two recent flash fictions) — [smokelong.com](https://www.smokelong.com)
- *Pithead Chapel* (read a recent issue) — [pitheadchapel.com](https://pitheadchapel.com)
- Poets & Writers, "Literary Magazines" — [pw.org](https://www.pw.org/content/literary_magazines) *(the searchable database of venues by genre and form)*

### Critical Reception
- *Literary Journals & Magazines (Poets & Writers)* — [pw.org](https://www.pw.org/content/literary_magazines) — the most trusted free guide to how the magazine ecosystem works and how to read it.
- *Using Chill Subs (Chill Subs FAQ)* — [support.chillsubs.com](https://support.chillsubs.com/faq/using-chill-subs) — a free walkthrough of browsing journals by genre, fee, pay, and vibe.
- *How to Navigate Our Listing Pages (Chill Subs)* — [support.chillsubs.com](https://support.chillsubs.com/how-tos/how-to-navigate-our-listing-pages) — how to decode a journal's guidelines, fees, and editor-provided examples before you submit.
...
### Session 3 — The Cover Letter & The Bio
...
### Reading
- Jane Friedman, "The Perfect Cover Letter: Advice From a Lit Mag Editor" — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) *(the model document, annotated by an editor)*
- Poets & Writers, "Literary Magazines" (cover-letter and bio guidance section) — [pw.org](https://www.pw.org/content/literary_magazines)
- Chill Subs cover-letter and bio fields explained — [support.chillsubs.com](https://support.chillsubs.com/how-tos/how-to-navigate-our-listing-pages) *(what each journal actually asks for)*
...
### Critical Reception
- *The Perfect Cover Letter: Advice From a Lit Mag Editor (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) — an editor explains, free, exactly what belongs in the 100–150 word letter and what to leave out.
- *Literary Journals & Magazines (Poets & Writers)* — [pw.org](https://www.pw.org/content/literary_magazines) — free guidance on keeping the letter simple and never using it to discuss the work's themes.
- *Using Chill Subs (Chill Subs)* — [support.chillsubs.com](https://support.chillsubs.com/faq/using-chill-subs) — describes the free tool for generating a short cover letter quickly and painlessly.
...
### Session 4 — Tools of the Trade: Tracking Submissions
...
### Reading
- *Using Chill Subs* — [support.chillsubs.com](https://support.chillsubs.com/faq/using-chill-subs) *(model walkthrough of a free tracking and discovery tool)*
- The Submission Grinder — [thegrinder.diabolicalplots.com](https://thegrinder.diabolicalplots.com) *(free response-time data and tracking)*
- Submittable — [submittable.com](https://www.submittable.com) *(the platform most journals use to receive work)*
...
### Critical Reception
- *Using Chill Subs (Chill Subs FAQ)* — [support.chillsubs.com](https://support.chillsubs.com/faq/using-chill-subs) — a free, plain-language guide to browsing and tracking submissions in a modern tool.
- *How to Navigate Our Listing Pages (Chill Subs)* — [support.chillsubs.com](https://support.chillsubs.com/how-tos/how-to-navigate-our-listing-pages) — how listing data (fees, documents per submission, simultaneous policy) feeds your tracker.
- *Creative Writing Contests & Grants — Submissions Tracker (Poets & Writers)* — [pw.org](https://www.pw.org/content/writing_contests_0) — describes a free submissions tracker for logging venues, fees, status, and elapsed time.
...
### Session 5 — Writing & Revising for Submission
...
### Reading
- Jane Friedman, "How to Immediately Improve Your Query Letter's Effectiveness" — [janefriedman.com](https://janefriedman.com/improve-your-query-letter/) *(on compression and leading with the strongest material — the same discipline a submission opening needs)*
- Jane Friedman, "The Perfect Cover Letter: Advice From a Lit Mag Editor" — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) *(an editor on what makes a busy reader stop)*
- A short, accessible flash piece from *SmokeLong Quarterly* as a model of compression — [smokelong.com](https://www.smokelong.com)

### Critical Reception
- *How to Immediately Improve Your Query Letter's Effectiveness (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/improve-your-query-letter/) — free advice on cutting to the premise that applies directly to revising openings.
- *The Perfect Cover Letter: Advice From a Lit Mag Editor (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) — a lit-mag editor on the reader's limited attention and how fast judgments are made.
- *Literary Journals & Magazines (Poets & Writers)* — [pw.org](https://www.pw.org/content/literary_magazines) — free guidance on matching length, form, and aesthetic to a venue.
...
### Session 6 — Rejection: The Real Curriculum
...
### Reading
- Jane Friedman, "Rejection May Not Be Personal, But …" — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection/) *(reframing the form letter)*
- Jane Friedman, "How to Deal With Rejection: Celebrate!" — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection-celebrate/) *(a four-step recovery plan)*
...
### Critical Reception
- *Rejection May Not Be Personal, But … (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection/) — a free, grounded reminder that rejection is of the work, not of the writer.
- *How to Deal With Rejection: Celebrate! (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection-celebrate/) — a free four-step plan for bouncing back and keeping work in motion.
- *Tips for Dealing With Rejection + Other Success Strategies (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/tips-for-dealing-with-rejection-other-success-strategies/) — free, candid strategies from writers who kept going.
...
### Session 7 — Book-Length Submissions: Novels & Story Collections
...
### Reading
- Jane Friedman, "How to Write a Query Letter That Gets Manuscript Requests" — [janefriedman.com](https://janefriedman.com/query-letters/) *(the model query, fully annotated)*
- Jane Friedman, "How to Write a Novel Synopsis" — [janefriedman.com](https://www.janefriedman.com/how-to-write-a-novel-synopsis/) *(the synopsis as a separate document)*
...
### Critical Reception
- *How to Write a Query Letter That Gets Manuscript Requests (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/query-letters/) — the clearest free guide to query elements, length, and comps.
- *The Conflicting Advice You'll Receive on Query Letters (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/conflicting-advice-youll-receive-query-letters/) — a free, honest look at why query guidance disagrees and what to actually do.
- *How to Immediately Improve Your Query Letter's Effectiveness (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/improve-your-query-letter/) — free advice on leading with the story premise and cutting the rest.
...
### Session 8 — Literary Agents: When You Need One, When You Don't
...
### Reading
- Authors Guild, "All About Literary Agents: Finding an Agent and What to Expect" — [authorsguild.org](https://authorsguild.org/resource/literary-agents/) *(the model overview and reputable databases)*
- Authors Guild, "Choosing a Literary Agent" — [authorsguild.org](https://authorsguild.org/resource/choosing-a-literary-agent/) *(querying in tiers, questions to ask, red flags)*
- Poets & Writers, "The Poets & Writers Guide to Literary Agents" — [pw.org](https://www.pw.org/content/the_poets_and_writers_guide_to_literary_agents)

### Critical Reception
- *All About Literary Agents (Authors Guild)* — [authorsguild.org](https://authorsguild.org/resource/literary-agents/) — a free, authoritative guide to where to find agents and what to expect.
- *Choosing a Literary Agent (Authors Guild)* — [authorsguild.org](https://authorsguild.org/resource/choosing-a-literary-agent/) — free, specific advice on tiered querying, the 15% standard, and "vanity" agents to avoid.
- *Nicole Aragi on Queries and Finding the Right Agent (Poets & Writers)* — [pw.org](https://www.pw.org/articles/feature) — a star agent's free interview on what stands out in a query.
...
### Session 9 — Small Presses: Where Most Literary Writers Actually Live
...
### Reading
- Coffee House Press catalog and submission guidelines — [coffeehousepress.org](https://coffeehousepress.org)
- Graywolf Press catalog — [graywolfpress.org](https://www.graywolfpress.org)
- Rose Metal Press (novella & short fiction) — [rosemetalpress.com](https://rosemetalpress.com)
- Authors Guild, "An Author's Guide to Agency Agreements" — [authorsguild.org](https://authorsguild.org/resource/an-authors-guide-to-agency-agreements/) *(model contract terms to understand before signing with any press)*

### Critical Reception
- *An Author's Guide to Agency Agreements (Authors Guild)* — [authorsguild.org](https://authorsguild.org/resource/an-authors-guide-to-agency-agreements/) — free guidance on the written terms every author should insist on understanding.
- *Negotiating a Book Contract (Authors Guild, free PDF)* — [authorsguild.org](https://authorsguild.org/app/uploads/2022/11/Chapter-11_Writers-Legal-Guide.pdf) — free, specific advice on publication deadlines, rights, and reversion in a small-press contract.
- *Poets & Writers* small-press and indie coverage — [pw.org](https://www.pw.org) — free reporting on the small-press world and the writers who live in it.
...
### Session 10 — Contests, Fellowships, Awards
...
### Reading
- Poets & Writers, "Writing Contests, Grants & Awards" database — [pw.org](https://www.pw.org/grants) *(the vetted list of legitimate contests)*
- Poets & Writers, "Creative Writing Contests & Grants" overview — [pw.org](https://www.pw.org/content/writing_contests_0)
...
### Critical Reception
- *Writing Contests, Grants & Awards (Poets & Writers)* — [pw.org](https://www.pw.org/grants) — the most trusted free database of vetted, legitimate contests, with cash prizes and deadlines.
- *Creative Writing Contests & Grants (Poets & Writers)* — [pw.org](https://www.pw.org/content/writing_contests_0) — free explanation of how P&W reviews each competition's practices before listing it.
- *Poets & Writers Submissions Tracker* — [pw.org](https://www.pw.org/content/writing_contests_0) — a free tool for tracking which contests you entered and how much you spent on fees.
...
### Session 11 — The Author Platform: What Helps and What Is a Waste of Time
...
### Reading
- Jane Friedman, "Lessons From 23 Years as a Self-Publishing Novelist" — [janefriedman.com](https://janefriedman.com/lessons-from-23-years-as-a-self-publishing-novelist/) *(a working writer on website, newsletter, and getting known — without panic)*
- Jane Friedman's blog (platform and marketing archive) — [janefriedman.com/blog](https://www.janefriedman.com/blog/)

### Critical Reception
- *Lessons From 23 Years as a Self-Publishing Novelist (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/lessons-from-23-years-as-a-self-publishing-novelist/) — a free, honest account of what platform work helps and what doesn't.
- *Jane Friedman's blog (platform archive)* — [janefriedman.com/blog](https://www.janefriedman.com/blog/) — the most reliable free running commentary on author websites, newsletters, and the platform myth.
- *The Business of Being a Writer with Jane Friedman (Draft2Digital blog)* — [draft2digital.com](https://janefriedman.com/the-business-of-being-a-writer/) — a free conversation on branding and consistent messaging without losing the work to it.
...
### Session 12 — Self-Publishing & Indie: The Honest Truth
...
### Reading
- Jane Friedman, "Lessons From 23 Years as a Self-Publishing Novelist" — [janefriedman.com](https://janefriedman.com/lessons-from-23-years-as-a-self-publishing-novelist/) *(the model account of an author-run path)*
- Jane Friedman, "Self-Publishing Checklist" (free PDF) — [janefriedman.com](https://janefriedman.com/wp-content/uploads/2015/12/Self-Publishing-Checklist.pdf) *(the production timeline, step by step)*
- KDP — [kdp.amazon.com] / IngramSpark — [ingramspark.com](https://www.ingramspark.com) / Draft2Digital — [draft2digital.com](https://draft2digital.com) *(the three core tools)*

### Critical Reception
- *Lessons From 23 Years as a Self-Publishing Novelist (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/lessons-from-23-years-as-a-self-publishing-novelist/) — a free, candid account of what self-publishing actually demands.
- *Self-Publishing Checklist (Jane Friedman, free PDF)* — [janefriedman.com](https://janefriedman.com/wp-content/uploads/2015/12/Self-Publishing-Checklist.pdf) — a free, concrete production and timeline checklist from manuscript to on-sale.
- *The Business of Being a Writer with Jane Friedman (Draft2Digital blog)* — [draft2digital.com](https://janefriedman.com/the-business-of-being-a-writer/) — a free interview on title, cover, description, and pricing for indie authors.
...
### Session 13 — Conferences, Residencies, MFAs
...
### Reading
- Poets & Writers, "MFA Programs Database" — [pw.org](https://www.pw.org/mfa) *(the funded/unfunded data)*
- Poets & Writers, "Conferences and Residencies Database" — [pw.org](https://www.pw.org/conferences_and_residencies)
- Yaddo — [yaddo.org](https://www.yaddo.org) / MacDowell — [macdowell.org](https://www.macdowell.org) / AWP — [awpwriter.org](https://www.awpwriter.org) *(application requirements to compare)*

### Critical Reception
- *MFA Programs Database (Poets & Writers)* — [pw.org](https://www.pw.org/mfa) — the free, comprehensive resource for comparing funded and unfunded programs.
- *How to Pick an MFA Program (Poets & Writers)* — [pw.org](https://www.pw.org/content/how_to_pick_an_mfa_program) — free guidance on choosing a program with clear eyes about cost and value.
- *Conferences and Residencies Database (Poets & Writers)* — [pw.org](https://www.pw.org/conferences_and_residencies) — a free, vetted listing of conferences and residencies with details and deadlines.
...
### Session 14 — Building a Submission Year
...
### Reading
- Poets & Writers, "Writing Contests, Grants & Awards" (and the free Submissions Tracker) — [pw.org](https://www.pw.org/grants) *(the model for planning a year by deadline)*
- Jane Friedman, "How to Deal With Rejection: Celebrate!" — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection-celebrate/) *(sustaining morale across a long year)*

### Critical Reception
- *Writing Contests, Grants & Awards (Poets & Writers)* — [pw.org](https://www.pw.org/grants) — a free, deadline-organized resource for structuring a realistic submission calendar.
- *Poets & Writers Submissions Tracker* — [pw.org](https://www.pw.org/content/writing_contests_0) — a free tool for logging submissions, fees, status, and elapsed time across a year.
- *How to Deal With Rejection: Celebrate! (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection-celebrate/) — free strategies for keeping a year's practice emotionally sustainable.
...
### Session 15 — Reading Together: Real Cover Letters, Real Queries, Real Rejections
...
### Reading
- Jane Friedman, "The Perfect Cover Letter: Advice From a Lit Mag Editor" — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) *(the model to revise against)*
- Jane Friedman, "How to Write a Query Letter That Gets Manuscript Requests" — [janefriedman.com](https://janefriedman.com/query-letters/)
...
### Critical Reception
- *The Perfect Cover Letter: Advice From a Lit Mag Editor (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/perfect-cover-letter-advice-lit-mag-editor/) — a free editor's-eye standard to revise letters against.
- *The Conflicting Advice You'll Receive on Query Letters (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/conflicting-advice-youll-receive-query-letters/) — free perspective on why query feedback differs and how to weigh it.
- *Nicole Aragi on Queries and Finding the Right Agent (Poets & Writers)* — [pw.org](https://www.pw.org/articles/feature) — a free agent interview on what makes a query stand out in the pile.
...
### Reading
- Poets & Writers (contests, agents, MFA, and grants hub) — [pw.org](https://www.pw.org) *(your standing free resource for the year ahead)*
- Jane Friedman's blog — [janefriedman.com/blog](https://www.janefriedman.com/blog/) *(the most reliable free ongoing guide as you execute the plan)*
- Your own completed submission packet: the chosen piece, the cover letter, the tracker, and the six-month plan.

### Critical Reception
- *Poets & Writers* — [pw.org](https://www.pw.org) — the central free hub to keep consulting as you submit through the coming year.
- *Jane Friedman's blog* — [janefriedman.com/blog](https://www.janefriedman.com/blog/) — free, reliable ongoing commentary to support the plan after the course ends.
- *How to Deal With Rejection: Celebrate! (Jane Friedman)* — [janefriedman.com](https://janefriedman.com/how-to-deal-with-rejection-celebrate/) — a free reminder, for the road, that persistence is the whole secret.
...
A note on access: every resource below is **free** to use. The platforms named are free to join (some offer paid upgrades you do not need to start). Publisher, journal, and contest pages are freely readable online. Where a book is recommended, request it from the **Free Library of Philadelphia** ([freelibrary.org](https://www.freelibrary.org)).
...
| Jane Friedman, "How to Write a Query Letter" | The clearest free guide to the form | [janefriedman.com](https://www.janefriedman.com/query-letters/) |
| The synopsis guide | How to write the 1–2 page synopsis | [janefriedman.com](https://www.janefriedman.com/how-to-write-a-novel-synopsis/) |

### Recommended Journals by Tier (free to read online)

| Tier | Journals |
|---|---|
| Top-tier | [The Paris Review](https://www.theparisreview.org), [The New Yorker](https://www.newyorker.com/magazine/fiction), [The Atlantic](https://www.theatlantic.com) |
| Mid-tier / prestigious | [Kenyon Review](https://kenyonreview.org), [Ploughshares](https://www.pshares.org), [AGNI](https://agnionline.bu.edu) |
| Strong independents | [Brevity](https://brevitymag.com), [Cleaver](https://www.cleavermagazine.com), [SmokeLong Quarterly](https://www.smokelong.com), [Hippocampus](https://hippocampusmagazine.com), [Pithead Chapel](https://pitheadchapel.com) |
| Accessible but respected | [Impspired](https://impspired.com), [The Galway Review](https://thegalwayreview.com), [Vita Brevis](https://vitabrevisliterature.wordpress.com/), [Sparks of Calliope](https://sparksofcalliope.com), [Academy of the Heart and Mind](https://academyoftheheartandmind.wordpress.com), [Fragmented Voices](https://fragmentedvoices.com), [Scars Publications / CC&D](http://scars.tv) |

### Recommended Small Presses by Genre

| Genre | Presses |
|---|---|
| Literary fiction | [Coffee House Press](https://coffeehousepress.org), [Graywolf Press](https://www.graywolfpress.org), [Tin House](https://tinhouse.com), [Two Dollar Radio](https://twodollarradio.com), [Soft Skull Press](https://softskull.com), [Sarabande Books](https://www.sarabandebooks.org) |
| Poetry | [Copper Canyon Press](https://www.coppercanyonpress.org), [BOA Editions](https://www.boaeditions.org), [Four Way Books](https://fourwaybooks.com), [Tupelo Press](https://www.tupelopress.org), [Black Lawrence Press](https://www.blacklawrence.com), [Sarabande Books](https://www.sarabandebooks.org) |
| Novella & short fiction | [Awst Press](https://www.awst-press.com), [Rose Metal Press](https://rosemetalpress.com) |

### Submission Tools (all free to start)

| Tool | Use | Access |
|---|---|---|
| Submittable | The platform most journals use to receive work | [submittable.com](https://www.submittable.com) |
| Chill Subs | Free, searchable database of journals and presses | [chillsubs.com](https://www.chillsubs.com) |
| The Submission Grinder | Free tracking and response-time data | [thegrinder.diabolicalplots.com](https://thegrinder.diabolicalplots.com) |
| Duotrope | Paid market database (optional) | [duotrope.com](https://duotrope.com) |
| NewPages | Listings, calls for submissions, and reviews | [newpages.com](https://www.newpages.com) |
| QueryTracker | Free database for finding literary agents | [querytracker.net](https://querytracker.net) |
| Publishers Marketplace | Industry deal data and agent listings | [publishersmarketplace.com](https://www.publishersmarketplace.com) |

### Contest List

| Contest | For | Access |
|---|---|---|
| Yale Series of Younger Poets | First poetry book | [yalebooks.yale.edu](https://yalebooks.yale.edu/series/yale-series-of-younger-poets/) |
| Iowa Short Fiction Award | Story collection | [uipress.uiowa.edu](https://www.uipress.uiowa.edu/series/iowa-short-fiction-award) |
| Flannery O'Connor Award for Short Fiction | Story collection | [ugapress.org](https://ugapress.org) |
| Drue Heinz Literature Prize | Short fiction | [upress.pitt.edu](https://upittpress.org/series/pitt-poetry-series/) |
| Bakeless Prize (Bread Loaf) | First books | [middlebury.edu/bread-loaf-writers-conference](https://www.middlebury.edu/bread-loaf-conferences) |
| BOA Short Fiction Prize | Short fiction | [boaeditions.org](https://www.boaeditions.org) |
| Pushcart Prize | Recognition (anthology) | [pushcartprize.com](https://www.pw.org/writing_contests/pushcart_prizes) |
| Best American series | Recognition (anthology) | [hmhbooks.com](https://www.hmhbooks.com) |
| Best Small Fictions | Recognition (anthology) | [Sonder Press / publisher listings](https://www.newpages.com) |

### Residency & Conference List

| Program | Type | Access |
|---|---|---|
| Yaddo | Residency | [yaddo.org](https://www.yaddo.org) |
| MacDowell | Residency | [macdowell.org](https://www.macdowell.org) |
| Virginia Center for the Creative Arts (VCCA) | Residency | [vcca.com](https://www.vcca.com) |
| Sewanee Writers' Conference | Conference | [sewaneewriters.org](https://www.sewaneewriters.org) |
| Bread Loaf Writers' Conference | Conference | [middlebury.edu](https://www.middlebury.edu/bread-loaf-conferences) |
| Tin House Workshop | Conference | [tinhouse.com/workshops](https://tinhouse.com/) |
| AWP Conference & Bookfair | Conference | [awpwriter.org](https://www.awpwriter.org) |
...
- **Jane Friedman's blog** — the most reliable free resource on contemporary publishing: [janefriedman.com/blog](https://www.janefriedman.com/blog/)
- **Poets & Writers** — grants, awards, contests, and the literary magazine database: [pw.org](https://www.pw.org)
...
Sending the same piece to more than one venue at the same time. Standard and accepted practice at the great majority of journals, because response times are so long that submitting to one venue at a time would mean a piece could circulate for years. When one venue accepts, you promptly withdraw the piece from the others.

**Simsub**
The common shorthand for a simultaneous submission. You will see it constantly in submission guidelines: "Simsubs welcome" or "No simsubs."

**Multiple Submission**
Sending more than one piece to the *same* venue at the same time — for example, three separate flash fictions in one submission window. Distinct from simultaneous submission. Some venues welcome it; some forbid it. Always check the guidelines.

**Query Letter**
A one-page letter, used for book-length work, whose only job is to persuade an agent or editor to request the manuscript. It contains a hook, a brief synopsis that includes the ending, and a short bio. It is a sales document, not a summary of themes.

**Synopsis**
A separate document, usually one to two pages, written in the present tense, that lays out the entire plot of a book *including the ending*. Its purpose is to demonstrate that the book holds together as a whole, not to entice. Frequently requested alongside a query.

**Slush Pile**
The accumulated mass of unsolicited submissions awaiting an editor's or agent's attention. Every submitting writer's work begins here. The term is not an insult; it is simply where the reading starts.

**The Slush**
Shorthand for the slush pile. To "read slush" is to work through unsolicited submissions — often the entry-level task at a journal or agency, and the place where many editorial careers, mine included, begin.

**Form Rejection**
A standardized rejection letter sent to most submitters, identical for everyone. It carries no personal judgment of your specific work — it simply means "not this one, not now." The overwhelming majority of rejections are form rejections, and they mean far less than they feel like they mean.

**Personal Rejection**
A rejection that includes an individual comment from an editor — a line about what they admired, or an invitation to send other work. This is a genuine signal of encouragement and is worth far more than its brevity suggests. It means a real person engaged with your real work.

**Tiered Rejection**
A rejection whose specific wording (some venues use slightly different form letters at different stages) indicates how far the piece advanced before being declined. A "higher-tier" form rejection signals the work got close. Submission databases sometimes help decode these.

**Reading Fee**
A fee charged to submit, common for contests and increasingly for some journals, typically three to thirty dollars. It helps fund the venue and, often, the prize. Worth paying when the potential reward (publication, a prize) justifies it; a waste when it does not. A *literary agent* who charges a reading fee, by contrast, is a red flag and should be avoided.

**Response Time**
How long a venue takes to reply to a submission. Three to nine months is normal; a year is not unusual; and some venues never respond at all. Tracking response times — through the Submission Grinder or your own spreadsheet — lets you plan a submission year realistically.
...
**The Comp Title**
A "comparable title" — a recently published book similar to yours in audience or sensibility, cited in a query to help an agent or editor place your work in the market. Good comps are recent, successful but not blockbuster, and genuinely similar. "*It's like* [a famous bestseller]" is a beginner's mistake.

**MS / ms**
Standard abbreviation for "manuscript." The plural is "MSS" or "mss." You will see it everywhere in guidelines and correspondence: "We accept unsolicited mss during our spring reading period."
...
And I have been the **writer**, sealing the envelopes. I have published novels — *Molly Bonamici* and *Give Them Unquiet Dreams*, named a Kirkus Best Book of 2019 — the novella *A Prayer for Home*, the short story collections *Assumptions*, *Blindfolded*, and *All We Ever Needed* (Silver Current Press, 2026), and the 2026 memoir *The Weight of Small Mercies*. I have been published over 300 times in literary magazines, journals, and anthologies in the United States and around the world. That record means I have done, several thousand times over, the exact thing this course teaches: write it, revise it, send it out, track it, get rejected, send it again. I have the acceptances, and I have many, many more rejections, and I will show you both, because the rejections are the more instructive half.
