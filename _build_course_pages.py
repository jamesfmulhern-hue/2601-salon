...
COURSES = {
    "american_lit": {
        ...
        "desc": "A sixteen-session course in American literature, taught by James F. Mulhern — open to adult readers, offered in person or online.",
    },
    "poetry": {
        "title": "Reading Poetry: A Beginner's Welcome",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session beginners' poetry course for adult readers, taught by James F. Mulhern — offered in person or online.",
    },
    "memoir": {
        "title": "The Personal Essay & Memoir",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on personal essay and memoir for adult readers and writers, taught by James F. Mulhern — offered in person or online.",
    },
    "shakespeare": {
        "title": "Shakespeare's Sonnets & Famous Speeches",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on Shakespeare's sonnets and most famous monologues, taught by James F. Mulhern — open to adult readers, offered in person or online.",
    },
    "women_writers": {
        "title": "Women in American Literature",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on American women writers, taught by James F. Mulhern — open to adult readers, offered in person or online.",
    },
    "minority_voices": {
        "title": "Minority Voices in American Literature",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on Black, Latinx, Asian American, Native American, and immigrant American voices, taught by James F. Mulhern — offered in person or online.",
    },
    "jewish_writers": {
        "title": "Jewish Writers: A Literary Tradition",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on Jewish American and international Jewish literature, taught by James F. Mulhern — open to adult readers, offered in person or online.",
    },
    "irish_lit": {
        "title": "The Irish Literary Imagination",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course on Irish literature, taught by James F. Mulhern — open to adult readers, offered in person or online.",
    },
    "revision_workshop": {
        "title": "The Craft of Revision — A Writers' Workshop",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session writers' workshop on revision, taught by James F. Mulhern — for adult writers, offered in person or online.",
    },
    "lit_and_history": {
        "title": "Literature & American History — A Cross-Reading",
        "subtitle": "Sixteen Sessions",
        "desc": "A sixteen-session course pairing primary historical documents with the literary works that answer them, taught by James F. Mulhern — offered in person or online.",
    },
    "writing_life": {
