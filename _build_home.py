...
<div class="card network-toc" id="toc">
  ...
  <details open>
    <summary>The Salon <span class="toc-count">13 free courses</span></summary>
    <ul>
  ...
  <details>
    <summary>Publishing Guides for Writers <span class="toc-count">Free field guides</span></summary>
    <ul>
  ...
  <details>
    ...
    <ul>
      ...
      <li><em>Mia Bambina and Other Stories</em> <span class="note">— story collection</span></li>
...
<div class="card" id="elsewhere">
  ...
  <ul>
    ...
    <li><em>Mia Bambina and Other Stories</em> (story collection).</li>
